...
# except ImportError:
#     pass
AWS_STORAGE_BUCKET_NAME = os.environ.get('fitgirl-empower-cat')
AWS_ACCESS_KEY_ID = os.environ.get('AKIAYR7E4FTMOXKZ6UXQ')
AWS_SECRET_ACCESS_KEY = os.environ.get('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')
