# Generated by Django 2.2.4 on 2020-05-01 00:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='KindnessCardTemplate',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('image_name', models.CharField(blank=True, max_length=25, null=True)),
                ('image', models.ImageField(blank=True, default='images/KCard.jpg', null=True, upload_to='images/')),
            ],
        ),
        migrations.CreateModel(
            name='Parameters',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('KCardTemplate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.KindnessCardTemplate')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('age_group', models.IntegerField(choices=[(1, '6'), (2, '7-10'), (3, '11-13'), (4, '14-16'), (5, '17+')], default=1, null=True)),
