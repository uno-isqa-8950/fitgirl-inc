# Generated by Django 2.2.10 on 2020-04-13 20:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email', models.EmailField(blank=True, max_length=254, null=None, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('KCardTemplate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.KindnessCardTemplate')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
